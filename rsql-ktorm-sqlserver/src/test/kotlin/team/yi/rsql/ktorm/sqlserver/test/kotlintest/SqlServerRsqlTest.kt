package team.yi.rsql.ktorm.sqlserver.test.kotlintest
...
import team.yi.rsql.ktorm.sqlserver.useSqlServer
import team.yi.rsql.ktorm.test.BaseTest
import team.yi.rsql.ktorm.test.model.Employees

class SqlServerRsqlTest : BaseTest() {
    private val log = KotlinLogging.logger {}

    companion object {
        private const val dockerImageName = "mcr.microsoft.com/mssql/server:2017-CU12"

        class KSqlServerContainer : MSSQLServerContainer<KSqlServerContainer>(dockerImageName)

        val dbContainer = KSqlServerContainer()
    }
