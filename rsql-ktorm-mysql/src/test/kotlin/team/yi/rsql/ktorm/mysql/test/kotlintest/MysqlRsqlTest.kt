package team.yi.rsql.ktorm.mysql.test.kotlintest
...
import team.yi.rsql.ktorm.mysql.useMysql
import team.yi.rsql.ktorm.test.BaseTest
import team.yi.rsql.ktorm.test.model.Employees

class MysqlRsqlTest : BaseTest() {
    private val log = KotlinLogging.logger {}

    companion object {
        private const val dockerImageName = "mysql:8.0.22"

        class KMySqlContainer : MySQLContainer<KMySqlContainer>(dockerImageName)

        val dbContainer = KMySqlContainer()
    }
